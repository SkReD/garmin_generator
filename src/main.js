...
const trackPoints = getTrackPoints(args.stepsCount, args.startLatitude, args.startLongitude,
    args.endLatitude, args.endLongitude, args.startTime, args.endTime, args.distanceDelta, args.timeDelta,
    args.heightDelta, args.height);
const distance = measureDistance(args.startLatitude, args.startLongitude, args.endLatitude, args.endLongitude);
