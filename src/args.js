...
module.exports.getArguments = function getArguments() {
    const args = require('yargs')
        ...
        .option('start-longitude', {
            type: 'string',
            describe: 'Начальная долгота (можно задать в градусах или в относительных велечинах)',
            demandOption: true,
        })
        .option('end-longitude', {
            type: 'string',
            describe: 'Конечная долгота (можно задать в градусах или в относительных велечинах)',
            demandOption: true,
        })
        .option('start-latitude', {
            type: 'string',
            describe: 'Начальная широта (можно задать в градусах или в относительных велечинах)',
            demandOption: true,
        })
        .option('end-latitude', {
            type: 'string',
            describe: 'Конечная широта (можно задать в градусах или в относительных велечинах)',
            demandOption: true,
        })
        .option('start-time', {
            type: 'string',
